...
const tree = {
    ...
    data: [
        ...
        },
        {
            ...
            assignees: [],
            organizations: [],
            projected_start_date: new Date("2025-01-14"),
            projected_end_date: new Date("2025-01-14"),
            slack: 0,
            color: "#9689B2",
            status: "ON_TIME",
            type: "task",
        ...
        },
        {
            ...
            assignees: [],
            organizations: [],
            projected_start_date: new Date("2025-01-15"),
            projected_end_date: new Date("2025-01-15"),
            slack: 0,
            color: "#9689B2",
            status: "ON_TIME",
            type: "task",
